...
El estudio del cálculo multivariable requiere una comprensión sólida de los espacios geométricos donde se desarrollan las funciones de varias variables. A continuación, formalizamos los conceptos del plano y el espacio euclidiano.
...
Los elementos del par ordenado reciben nombres específicos:
\begin{itemize}
...
Los ejes coordenados dividen al plano en cuatro regiones denominadas \textbf{cuadrantes}, numerados en sentido antihorario comenzando por el superior derecho (donde ambas coordenadas son positivas).

\begin{center}
\shorthandoff{>} % Necesario con babel-spanish para evitar conflictos en tikz
