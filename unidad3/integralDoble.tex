...
Para empezar, consideremos una región rectangular
\[
...
\]
aproxima el volumen. Al hacer los rectángulos cada vez más pequeños, la aproximación se vuelve exacta. Este límite se llama \textbf{integral doble} de $f$ sobre $R$ y se escribe
\[
\iint_R f(x,y)\,dA.
\]
...
El teorema de Fubini justifica el método anterior. Dice que, para las funciones continuas en un rectángulo dado se puede elegir el orden más conveniente.
...
Hasta ahora se integró sobre rectángulos. Sin embargo, muchas regiones importantes están delimitadas por rectas, parábolas, circunferencias u otras curvas. Una \textbf{región general} es una región $R$ del plano que puede describirse mediante límites que dependen de una de las variables.
...
\]
Para cada valor fijo de $x$, $y$ comienza en la curva inferior $g_1(x)$ y termina en la curva superior $g_2(x)$. Por el teorema de Fubini,
\[
\iint_R f(x,y)\,dA
...
Las coordenadas polares describen un punto del plano mediante su distancia al origen y el ángulo que forma con el eje $x$. En lugar de usar $(x,y)$, usamos $(r,\theta)$, donde $r\geq0$ y $\theta$ se mide en radianes.
...
En polares, el disco se describe simplemente por $0\leq r\leq2$ y $0\leq\theta\leq2\pi$. Como el área corresponde a $f(x,y)=1$,
\[
...
La descripción polar es $0\leq\theta\leq\pi/2$ y $1\leq r\leq2$. Además,
\[
...
Los ejercicios están ordenados de menor a mayor dificultad. Los primeros consolidan el uso de regiones Tipo I y Tipo II; después se introducen coordenadas polares y, al final, aplicaciones de la integral doble.
\begin{enumerate}
    \item \input{unidad3/integralDoble/ex1.tex}
    \item \input{unidad3/integralDoble/ex2.tex}
    \item \input{unidad3/integralDoble/ex3.tex}
    \item \input{unidad3/integralDoble/ex4.tex}
    \item \input{unidad3/integralDoble/ex5.tex}
    \item \input{unidad3/integralDoble/ex6.tex}
    \item \input{unidad3/integralDoble/ex7.tex}
    \item \input{unidad3/integralDoble/ex8.tex}
    \item \input{unidad3/integralDoble/ex9.tex}
    \item \input{unidad3/integralDoble/ex10.tex}
    \item \input{unidad3/integralDoble/ex11.tex}
    \item \input{unidad3/integralDoble/ex12.tex}
    \item \input{unidad3/integralDoble/ex13.tex}
    \item \input{unidad3/integralDoble/ex14.tex}
    \item \input{unidad3/integralDoble/ex15.tex}
    \item \input{unidad3/integralDoble/ex16.tex}
    \item \input{unidad3/integralDoble/ex17.tex}
    \item \input{unidad3/integralDoble/ex18.tex}
    \item \input{unidad3/integralDoble/ex19.tex}
    \item \input{unidad3/integralDoble/ex20.tex}
    \newpage
    \item \input{unidad3/integralDoble/ex21.tex}
\end{enumerate}
