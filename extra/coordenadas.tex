...
\subsection{Intuición geométricaz}
...
\]
representan el mismo punto. Por ello generalmente se toma $0\leq\theta<2\pi$ para que cada punto tenga una sola representación polar.
...
\sin\theta=\frac{y}{r}.
\]
Obteniendo así las dos componentes rectangulares del vector:
\[
x=r\cos\theta,
\qquad
y=r\sin\theta.
...
\subsection{Conversiones entre sistemas de coordenadas}
...
\begin{tikzpicture}[x={(-0.55cm,-0.28cm)}, y={(1cm,0cm)}, z={(0cm,1cm)}, scale=1, every node/.style={font=\small}]
    ...
    \node[blue!75!black, inner sep=1pt, yshift=2pt] at (B) {$B$};
\end{tikzpicture}
\end{center}
...
Imagina una esfera centrada en el origen. Primero se elige una dirección horizontal sobre el plano $xy$ con $\theta$; después se inclina esa dirección mediante $\varphi$ y, por último, se avanza una distancia $\rho$. De este modo, $(\rho,\theta,\varphi)$ localiza cualquier punto fuera del origen.
...
\begin{tikzpicture}[x={(-0.55cm,-0.28cm)}, y={(1cm,0cm)}, z={(0cm,1cm)}, scale=1, every node/.style={font=\small}]
    ...
    \node[blue!75!black, yshift=2pt] at (B) {$B$};
\end{tikzpicture}
\end{center}
...
\begin{enumerate}
    \item \input{extra/ejercicios/coordenadas/ex1.tex}
    \item \input{extra/ejercicios/coordenadas/ex2.tex}
    \item \input{extra/ejercicios/coordenadas/ex3.tex}
    \item \input{extra/ejercicios/coordenadas/ex4.tex}
    \item \input{extra/ejercicios/coordenadas/ex5.tex}
    \item \input{extra/ejercicios/coordenadas/ex6.tex}
    \item \input{extra/ejercicios/coordenadas/ex7.tex}
    \item \input{extra/ejercicios/coordenadas/ex8.tex}
    \item \input{extra/ejercicios/coordenadas/ex9.tex}
    \item \input{extra/ejercicios/coordenadas/ex10.tex}
\end{enumerate}
