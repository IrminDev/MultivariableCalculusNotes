...
\textit{Nota muy importante:} Aunque hablamos de "longitud", la componente escalar puede ser un número negativo. Si el ángulo $\theta$ entre los vectores es mayor a $90^\circ$, el coseno será negativo. Geométricamente, esto significa que la proyección "sombra" está apuntando en la dirección opuesta al vector $\vec{v}$.