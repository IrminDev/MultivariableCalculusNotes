...
En muchas aplicaciones de ingeniería, a menudo se requiere únicamente la \textit{dirección} y el \textit{sentido} en el que actúa un fenómeno (como la dirección del flujo de un fluido o la línea de acción de una fuerza), independientemente de su magnitud. Para aislar esta información, se utilizan los vectores unitarios.
